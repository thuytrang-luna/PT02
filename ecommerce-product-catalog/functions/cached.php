...
function ic_process_current_products(
	...
	if ( empty( $_GET['s'] ) && empty( $args['al_product-cat'] ) && empty( $args ['tax_query'] ) && empty( $args ['meta_query'] ) && ! is_ic_only_main_cats() && ! apply_filters( 'ic_force_query_count_calculation', false ) ) {
		return 'all';
	}
