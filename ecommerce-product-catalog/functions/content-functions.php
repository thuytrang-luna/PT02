...
function ic_localize_main_catalog_js() {
	...
	wp_localize_script( 'al_product_scripts', 'product_object', apply_filters( 'ic_catalog_product_object_js', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ), 'post_id' => ic_get_product_id(), 'lightbox_settings' => $colorbox_set, 'filter_button_label' => __( 'Filter', 'ecommerce-product-catalog' ), 'design_schemes' => design_schemes( 'box', 0 ) ) ) );
}
