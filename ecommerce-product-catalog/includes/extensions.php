		...
		<div class="table-wrapper">
			...
			if ( $tab == 'product-extensions' OR $tab == '' ) {
				...
				<div class="help">
					...
					<ol>
						<li>Go to the <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=product-settings' ) ?>">general settings page</a></li>
						<li>Select your main catalog page and the template</li>
						<li><a href="<?php echo admin_url( 'post-new.php?post_type=al_product' ) ?>">Add your first product</a> and check how it looks like by clicking the generated link after you publish it</li>
						...
						<li>Make necessary adjustments in <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=product-settings' ) ?>">General settings</a>, <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=attributes-settings&submenu=attributes' ) ?>">Attributes</a>, <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=shipping-settings&submenu=shipping' ) ?>">Shipping</a>, <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=design-settings&submenu=archive-design' ) ?>">Catalog Design</a> and <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php&tab=names-settings&submenu=single-names' ) ?>">Front-end Labels</a></li>
						<li>Use the search box on the top of this page if you need more information</li>
						<li>Check the <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=extensions.php' ) ?>">Add-ons and Integrations</a> for more free and premium features</li>
						<li>Use free <a target="_blank" href="https://wordpress.org/support/plugin/ecommerce-product-catalog/">support forum</a> or <a target="_blank" href="https://implecode.com/support/#cam=help-tab&key=premium-support">premium support service</a> to get professional help</li>
					...
					<a class="button-secondary" target="_blank" href="https://wordpress.org/support/plugin/ecommerce-product-catalog/">Free Support Forum</a>
					<a class="button-secondary" target="_blank" href="https://implecode.com/support/#cam=help-tab&key=support">Premium Support Service</a>
					<h3><?php _e( 'How to Install the extension?', 'ecommerce-product-catalog' ) ?></h3>
					<ol>
						<li>Go to the <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=extensions.php' ) ?>">extensions page</a></li>
					...
					<p>In case you prefer to install the extension manually you will get also the installation files in the customer panel. See <a href="https://implecode.com/wordpress/product-catalog/plugin-installation-guide/#cam=extensions-help&key=manual-installation#manual">manual installation guide</a> for this.</p>
					<p>Please see the <a href="https://implecode.com/faq/#cam=extensions-help&key=faq">FAQ</a> for additional information</p>
				</div>
				<div class="helpers">
					<div class="wrapper"><h2><?php _e( 'Did you Know?', 'ecommerce-product-catalog' ) ?></h2><?php
...
function add_product_catalog_extensions_url() {
	if ( current_user_can( 'install_plugins' ) ) {
		?>
		<a id="extensions" class="nav-tab" href="<?php echo admin_url( 'edit.php?post_type=al_product&page=extensions.php' ) ?>"><?php _e( 'Add-ons & Integrations', 'ecommerce-product-catalog' ); ?></a>
		<?php
	}
	?>
	<a id="help" class="nav-tab" href="<?php echo admin_url( 'edit.php?post_type=al_product&page=extensions.php&tab=help' ) ?>"><?php _e( 'Help', 'ecommerce-product-catalog' ); ?></a>
