...
function ic_order_details_fields() {
	$fields = array( 'status', 'date', 'name', 'email', 'billing_name', 'tax_code', 'street', 'postcode', 'city', 'country', 'country_code', 'shipping_email', 'currency', 'vatid', 'vat_name', 'vat_address', 'vat_country', 'vat_ver_id' );
	return $fields;
}
...
function ic_add_row_button() {
	...
	<div class="add-digital-product" >
		<input type="button" id="add-digital-product" class="button" name="add_product" value="<?php _e( 'Add Product', 'ecommerce-product-catalog' ) ?>" />
		<input type="button" id="add-custom-digital-product" class="button" name="add_custom_product" value="<?php _e( 'Add Custom Product', 'ecommerce-product-catalog' ) ?>" /></div>
	<?php
}
