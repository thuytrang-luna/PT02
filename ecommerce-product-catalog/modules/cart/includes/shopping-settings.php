	...
	if ( $submenu == 'shopping-cart' ) {
		...
		<div class="shopping-cart-settings setting-content submenu">
			<form method="post" action="options.php">
				...
				<table><?php
					implecode_settings_radio( __( 'Remember fields by', 'ecommerce-product-catalog' ), 'shopping_cart_settings[form_registration]', $shopping_cart_settings[ 'form_registration' ], array( 'user' => __( 'User Account', 'ecommerce-product-catalog' ), 'cookie' => __( 'Cookie Save', 'ecommerce-product-catalog' ) ), 1, __( 'If you select user account you will be able to select a page to become user account with the order history.', 'ecommerce-product-catalog' ) );
