...
function ic_attributes_settings_rows( $attribute, $attribute_label, $attribute_unit, $names = null, $max_num = null ) {
	...
	for ( $i = 1; $i <= $max_num; $i++ ) {
		...
		<tr>
			...
			<td class="product-attribute-label-column"><input class="product-attribute-label" type="text" data-base_name="<?php echo $names[ 'label' ] ?>" name="<?php echo $names[ 'label' ] ?>[<?php echo $i ?>]" value="<?php echo esc_html( $attribute_label[ $i ] ) ?>" /></td><td class="lp-column">:</td>
			<td><input class="product-attribute" type="text" data-base_name="<?php echo $names[ 'value' ] ?>" name="<?php echo $names[ 'value' ] ?>[<?php echo $i ?>]" value="<?php echo esc_html( $attribute[ $i ] ) ?>" /></td>
			<td><input id="admin-number-field" class="product-attribute-unit" type="text" data-base_name="<?php echo $names[ 'unit' ] ?>" name="<?php echo $names[ 'unit' ] ?>[<?php echo $i ?>]" value="<?php echo esc_html( $attribute_unit[ $i ] ) ?>" /></td>
